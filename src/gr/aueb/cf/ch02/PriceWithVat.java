...
public class PriceWithVat {
    public static void main(String[] args) {
        ...
        System.out.printf("Price: %.2f, Vat: %.2f, Price with vat: %.2f", inputPrice, vat, priceWithVat); // %f used to print the doubles and .2 -> how many digits are shown after coma
    }
}
